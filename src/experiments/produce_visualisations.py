...
def main(dataset_names: str):
    ...
    for dataset_name in dataset_names:
        ...
        for split_name, data_filename in splits:
            ...
            plot_class_cardinalities_and_hardness(class_cardinalities, hardness_by_class_max, dataset_name,
                                                  figure_save_path)
            ...
            for est in estimators:
                plot_relative_stability_of_estimates(all_hard_samples, thresholds, model_counts, est, dataset_name,
                                                     figure_save_path)
                plot_consecutive_stability(all_hard_samples, thresholds, model_counts, est, dataset_name,
                                           figure_save_path)
...
if __name__ == '__main__':
    ...
    main(args.dataset_name if args.dataset_name else None)
